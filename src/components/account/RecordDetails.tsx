// /src/components/account/RecordDetails.tsx
  ...
  return (
    <main className="grid gap-4 place-items-center">
      <div className="w-full flex flex-col gap-2 lg:gap-4 sm:items-start items-center">
        ...
        <div className="md:w-1/4 w-full flex sm:flex-row flex-col gap-2">
          <button
            ...
            className={`w-full rounded-full p-2 sm:text-base text-sm font-semibold transition-colors duration-300 ease-in-out border-2 border-solid
              ${
                activeTab === "tab1"
                  ...
                  : "border-border-tombol bg-back-ground text-hitam-judul-body cursor-pointer"
              }
          `}>
            Kupon
          </button>
          <button
            ...
            className={`w-full rounded-full p-2 sm:text-base text-sm font-semibold transition-colors duration-300 ease-in-out border-2 border-solid
              ${
                activeTab === "tab2"
                  ? "border-back-ground text-back-ground bg-hitam-judul-body"
                  : "border-border-tombol bg-back-ground text-hitam-judul-body hover:bg-hitam-judul-body cursor-pointer"
              }
          `}>
            Poin
          </button>
